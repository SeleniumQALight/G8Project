...
import apiTest.dto.responseDto.AuthorDTO;
import apiTest.dto.responseDto.PostsDto;
    ...
    public void getAllPostByUser() {
        PostsDto[] actualResponseAsDto =
                given()
                        ...
                        .assertThat()
                        .body("[0].title", equalTo("test2")) //0 element
                        .body("author.username", everyItem(equalTo(USER_NAME))) //якщо вкладений жейсон .list of values
        ...
        softAssertions.assertThat(actualResponseAsDto).usingRecursiveComparison()
                .ignoringFields("id","createdDate","author.avatar").isEqualTo(expectedDto);
