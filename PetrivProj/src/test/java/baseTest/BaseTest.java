...
public class BaseTest {
    ...
    @Before
    public void setUp() {
        logger.info("---- " + testName.getMethodName() + " was started ----"); // output test name to console when test is started
    ...
    public void tearDown() {
        ...
        logger.info("---- " + testName.getMethodName() + " was ended ----"); // output test name to console when test is finished
    }
