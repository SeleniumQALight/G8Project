...
public class CreatePostByApiTest {
    ...
    public void createPostByApi() {
        // int numberOfPosts = apiHelper.getAllPostsByUserAddDTO(VALID_LOGIN_API).length;
        ...
        PostsDto[] actualPostsByUser = apiHelper.getAllPostsByUserAddDTO(VALID_LOGIN_API);
