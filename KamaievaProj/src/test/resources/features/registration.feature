...
Feature: Login feature
  ...
  Scenario Outline: R004 Validation Messages for Login page
    ...
    Examples:
      ...
      | natakamanata         | tr        | tr                                                  | You must provide a valid email address.;Password must be at least 12 characters.                                                |
      | taras                | tr@tr.com | tr                                                  | Password must be at least 12 characters.                                                                                        |
      | nataliia             | no        | abcdefghijklmpqrstuv37776543werqwrtrrrr12===^%^###@ | You must provide a valid email address.;Password cannot exceed 50 characters.                                                   |
      | 1$%&/()=?*<abqrstuv> | @.com     | 1234567890                                          | Username can only contain letters and numbers.;You must provide a valid email address.;Password must be at least 12 characters. |