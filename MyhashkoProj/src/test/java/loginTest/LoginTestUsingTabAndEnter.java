...
public void login() {
        ...
        pageProvider.loginPage().pressTabKey(); // 2. Press Tab key
        pageProvider.loginPage().pressTabKey(); // 3. Press Tab key
        ...
        pageProvider.loginPage().pressTabKey(); // 5. Press Tab key
