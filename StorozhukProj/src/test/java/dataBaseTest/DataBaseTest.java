...
public class DataBaseTest {
    ...
    public void testDataFromDB() throws SQLException, ClassNotFoundException {
        ...
        logger.info("Number with records with login " + LOGIN + " is " + dataFromSeleniumTable.size());

        int numberOfInsertedRows = database.changeTable("INSERT INTO seleniumTable VALUES ('962','%s','%s')", LOGIN, "1234");
