...
public class DB_Util_seleniumUsers {
    ...
    public String getPassByLogin(String login) throws SQLException, ClassNotFoundException {
    ...
    public String getAliasByLogin(String login) throws SQLException, ClassNotFoundException {
        mySQL_DataBase = MySQL_Database.getDataBase();
        logger.info("--- Connected to DB -------");
