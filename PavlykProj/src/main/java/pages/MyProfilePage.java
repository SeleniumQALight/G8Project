...
public class MyProfilePage extends ParentPage{
    ...
    public MyProfilePage chckIsRedirectToMyProfilePage(){
        checkUrlWithPattern();
    ...
    public PostPage clickOnPostWithTitle(String postTitle) {
        ...
        // )))); //findElement can return exception if element is not found

        clickOnElement(String.format(postTitleLocator, postTitle)); //findElement can return exception if element is not found
